...
from tkinter import StringVar, Text, INSERT, Toplevel, messagebox
...
def everything():
	#--------------------------------- Beef -----------------------------------------------------------------
	def gen_terms():
		messagebox.showinfo("General Terms","Do you want to see the table of contents?(Highly Suggested): ")
		knowledge = input()
		...
		if knowledge == "yes" or "yea":
			print (gen_terms)
			messagebox.showinfo("General Terms","Cool! Hello, what do you want to learn today?")
			term = input()
			messagebox.showinfo("General Terms",help(term))
			if term not in gen_terms:
				messagebox.showinfo("General Terms","You might want to get the table of contents because what you chose is not in the list")
	#--------------------------------------------------------------------------------------------------------------

	def strings():
		messagebox.showinfo("Strings","Do you want to see the table of contents?(Highly Suggested): ")
		knowledge = input()
		knowledge = knowledge.lower()
		...
		if knowledge == "yes" or "yea":
			...
			input("Press Enter")
			print(" ")
			messagebox.showinfo("Strings","Which one of those do you want to learn about: ")
			choose = input()
			choose = choose.lower()
